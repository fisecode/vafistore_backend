...
// Datatable (jquery)
$(function () {
  var dt_postpaid_table = $('.datatables-product'),
    select1 = $('#filterBrand'),
  ...
  if (dt_postpaid_table.length) {
    var dt_postpaid = dt_postpaid_table.DataTable({
      processing: true,
      serverSide: true,
      ajax: {
        url: baseUrl + 'dashboard/product/postpaid-list',
        data: function (d) {
      ...
      <div class="d-flex justify-content-start align-items-center product-name">
        ...
        },
        {
          ...
          orderable: false,
          render: function (data, type, full, meta) {
            var edit = baseUrl + 'dashboard/product/postpaid' + full['id'] + '/edit';
            return (
  ...
  $(document).on('click', '.edit-record', function () {
    ...
    // get data
    $.get(`${baseUrl}dashboard/product/postpaid-list\/${product_id}\/edit`, function (data) {
      let provider = '';
      if (data.provider == 4) {
  ...
  $(document).on('change', '.switch-input', function () {
    ...
    $.ajax({
      method: 'PUT',
      url: `${baseUrl}dashboard/product/postpaid-list/${id}`,
      data: {
