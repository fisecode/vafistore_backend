...
<div class="add-page">
  <form id="add-page" role="form" action="{{ route('page-list.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <!-- Add Page -->
    @if ($isEdit)
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
      ...
      <div class="d-flex align-content-center flex-wrap gap-3">
        ...
        <button type="submit" name="{{ $isEdit ? 'update' : 'publish' }}" class="btn btn-primary">{{ $isEdit ? 'Update'
          : 'Publish' }}</button>
      </div>
    </div>
    <div class="row">
        ...
        <div class="card mb-4">
          <div class="card-body">
            ...
            <div class="form-floating form-floating-outline mb-4">
              <input type="text" class="form-control" id="page-title" placeholder="Add Title" name="title"
                aria-label="Page title" value="{{ $isEdit ? $productCategory->name : '' }}">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <div class="text-center mb-3">
              @if ($isEdit)
              <img src="{{ asset('storage/assets/img/product/category/' . $productCategory->image) }}" alt="page-img"
                class="w-100 h-auto rounded" id="uploadedImage" />
              @else
              <img src="" alt="product-img" class="w-100 h-auto hide-item rounded" id="uploadedImage" />
              @endif
            </div>
