...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified'])->group(function () {
  ...
  Route::group(['middleware' => ['allowed.role:super admin']], function () {
    ...
    Route::group(['prefix' => 'dashboard'], function () {
      ...
      Route::post('/product/prepaid/save-bulk-edit/', [PrepaidController::class, 'saveBulkEdit'])->name(
        'save-bulk-edit'
      );
      //Postpaid Product
      ...
      Route::post('/product/postpaid/save-bulk-edit/', [PostpaidController::class, 'saveBulkEdit'])->name(
        'save-bulk-edit'
      );
      //Voucher Product
      ...
      Route::post('/product/voucher/save-bulk-edit/', [VoucherController::class, 'saveBulkEdit'])->name(
        'save-bulk-edit'
      );
      //Entertainment Product
      Route::resource('/product/entertainment-list', EntertainmentController::class);
      Route::get('/product/entertainment', [EntertainmentController::class, 'EntertainmentManagement'])->name(
        'product-entertainment'
      );
      Route::post('/product/entertainment/save-bulk-edit/', [EntertainmentController::class, 'saveBulkEdit'])->name(
        'save-bulk-edit'
      );
      //Social Media Product
      Route::resource('/product/social-media-list', SocialMediaController::class);
      Route::get('/product/social-media', [SocialMediaController::class, 'SocialMediaManagement'])->name(
        'product-social-media'
      );
      Route::post('/product/social-media/save-bulk-edit/', [SocialMediaController::class, 'saveBulkEdit'])->name(
        'save-bulk-edit'
      );
      //Category Product
      Route::resource('/product/category-list', ProductCategoryController::class);
      Route::get('product/category', [ProductCategoryController::class, 'ProductCategoryManagement'])->name(
        'category-product'
      );
      Route::get('product/category/add', [ProductCategoryController::class, 'create'])->name('category-product.add');
      Route::get('product/category/{id}/edit', [ProductCategoryController::class, 'edit'])->name(
...
Route::group(['middleware' => config('fortify.middleware', ['web'])], function () {
  ...
  Route::post(RoutePath::for('login', '/auth/login'), [AuthenticatedSessionController::class, 'store'])->middleware(
    array_filter(['guest:' . config('fortify.guard'), $limiter ? 'throttle:' . $limiter : null])
  );
  Route::post(RoutePath::for('login', '/admin/login'), [AuthenticatedSessionController::class, 'store'])->middleware(
    array_filter(['guest:' . config('fortify.guard'), $limiter ? 'throttle:' . $limiter : null])
  );
